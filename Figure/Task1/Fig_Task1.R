setwd("C:/Users/19844/Desktop/aModel/Figure/Task1 - 副本")
...
bar_t1_1 = FigBar2('Task1_Result_1.csv', my_colors, ' ', c(0.5, 1), model_ls, 'b', c('MSE', 'RMSE'))
bar_t1_2 = FigBar1('Task1_Result_2.csv', my_colors, ' ', c(0.75, 0.95), model_ls, 'c', c('PCC', 'R2'))

box_sp = FigBox('MSE_SP.csv', my_colors, 'MSE on novel\ncells and drugs', c(2, 7), model_ls, 25, 'd')
...
p1 = grid.arrange(fig, bar_t1_1, bar_t1_2, box_sp, nrow = 1, widths = c(1.65, 0.58, 1, 0.58))
