...
train_loader = DataLoader(MyDataSet(Gtrain[:-1]), batch_size=batch_size, shuffle=True, collate_fn=my_collate)
...
for epoch in range(EPOCHS):
    ...
    for it, (pyg_batch, GeneFt, BionicFt) in enumerate(train_loader):
        ...
        prediction, _ = model(pyg_batch.x, pyg_batch, GeneFt, BionicFt)
