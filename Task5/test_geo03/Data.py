...
GEO03_pCR_dict = joblib.load('../DataPreprocess/GEO/3/GEO03_pCR_dict.pkl')
GEO03_RD_dict = joblib.load('../DataPreprocess/GEO/3/GEO03_RD_dict.pkl')
...
RMA_dict = Merge(GEO03_pCR_dict, GEO03_RD_dict)
GEF = []
...
Pair_pCR = []
Pair_RD = []
for each in GEO03_pCR_dict:
    Pair_pCR.append((each, drug))
for each in GEO03_RD_dict:
