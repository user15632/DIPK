...
GEO02_pCR_dict = joblib.load('../DataPreprocess/GEO/2/GEO02_pCR_dict.pkl')
GEO02_RD_dict = joblib.load('../DataPreprocess/GEO/2/GEO02_nCR_dict.pkl')
...
RMA_dict = Merge(GEO02_pCR_dict, GEO02_RD_dict)
GEF = []
...
Pair_pCR = []
Pair_RD = []
for each in GEO02_pCR_dict:
    Pair_pCR.append((each, drug))
for each in GEO02_RD_dict:
