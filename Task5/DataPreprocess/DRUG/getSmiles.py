...
# 导入数据
train_set = pd.read_csv('../../Dataset/GDSC_LN_IC50.csv', header=0)
...
# ['TL-1-85', 'THZ-2-102-1', 'QL-XII-61', 'Genentech Cpd 10', 'THZ-2-49', 'KIN001-236', 'QL-VIII-58',
# 'XMD15-27', 'TL-2-105', 'ICL1100013', 'rTRAIL', 'JQ12']
